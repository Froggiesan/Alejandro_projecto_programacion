 ...
 */
package inmobiliaria_empresa_clases_usuarios;
...
public class Trabajador extends Usuario {
    ...
    public String[][] listarTrabajador() throws SQLException{
        Connection conn = acceso_a_BD.getConnection();
        Controlador consulta = new Controlador();
        
        return consulta.mostrarTrabajador(conn);
        
    }
    
    public String[][] listarTrabajadorVentasGaP() throws SQLException{
        Connection conn = acceso_a_BD.getConnection();
        Controlador consulta = new Controlador();
        
        return consulta.mostrarTrabVentasGaP(conn);
        
    }  
    public String[][] listarTrabajadorVentasPaG() throws SQLException{
        Connection conn = acceso_a_BD.getConnection();
        Controlador consulta = new Controlador();
        String[][] cip = consulta.mostrarTrabVentasPaG(conn);
