...
public class ConsBBDD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Buscar Sentencia");

        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setText("Sentencia BBDD");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/logo_empresa/48.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsBBDD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
