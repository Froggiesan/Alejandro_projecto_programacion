...
import inmobiliaria_empresa_Clases_Viviendas.Alquileres;
...
public class Controlador {
    ...
    public String agregarVivienda(Connection con,Viviendas emp){
        PreparedStatement pst = null;
        String mensaje="";
        String sql="INSERT INTO \"SYSTEM\".\"VIVIENDA\" (CALLE, DESCRIPCION) VALUES (?,?)";
        try {
            pst = con.prepareStatement(sql);
    ...
    public String agregarVenta(Connection con,Ventas emp){
        PreparedStatement pst = null;
        String sql ="INSERT INTO \"SYSTEM\".\"VENTA\" (ID_VIVIENDA,PRECIO)"
                + " VALUES (?,?);";
        try {
            pst = con.prepareStatement(sql);
            pst.setInt(1, emp.getId());
            pst.setInt(2, emp.getPrecio());
            mensaje="guardado correctamente";
            System.out.println(mensaje);
            pst.execute();
            pst.close();
    ...
    public String agregarAlquiler(Connection con,Alquileres emp){
        PreparedStatement pst = null;
        String sql ="INSERT INTO \"SYSTEM\".\"ALQUILER\" (ID_VIVIENDA,PRECIO)"
                + " VALUES (?,?);";
        try {
            pst = con.prepareStatement(sql);
            pst.setInt(1, emp.getId());
    ...
    public ArrayList<String> getFotosVivienda(Connection con, int viviedaId){
        String sql = "SELECT URL FROM \"Systen\".\"Fotos_vivienda\" WHERE ID=" + viviedaId;
        ...
        try {
            ...
            while(rs.next()){
                for (int i = 0; i < 1; i++) {
                    fotos.add(rs.getString(i+1)); //recorremos las filas
                }
            }
            return fotos;
        }
    ...
    public String [][] mostrarTrabajador(Connection con){
        DefaultTableModel model;
    ...
    public String [][] mostrarVivienda(Connection con){
        DefaultTableModel model;
        String [] columnas = {"CALLE","DESCRIPCION","ID_VIVIENDA ORDER BY CALLE"};
        model = new DefaultTableModel(null,columnas);
        ...
        try {
            ...
            while(rs.next()){
                ...
                Viviendas.add(Arrays.copyOf(filas, 4));
            }
            return Viviendas.toArray(String[][]::new);
        }catch(Excepcionespropias e){
            System.out.println("Ha habido un problema al mostrar la tabla , consultar al administrador");
        }
        catch (Exception e) {
    ...
    public String [][] mostrarTrabVentasGaP(Connection con){
        DefaultTableModel model;
        String [] columnas = {"ID_USUARIO","SUELDO","VENTAS","ID_TRABAJADOR"};
        model = new DefaultTableModel(null,columnas);
    ...
    public String [][] mostrarTrabVentasPaG(Connection con){
        DefaultTableModel model;
        String [] columnas = {"ID_USUARIO","SUELDO","VENTAS","ID_TRABAJADOR"};
        model = new DefaultTableModel(null,columnas);
    ...
    public String [][] mostrarViviendaPrecioGaP(Connection con){
        DefaultTableModel model;
    ...
    public String [][] mostrarViviendaPrecioPaG(Connection con){
        DefaultTableModel model;
        String [] columnas = {"CALLE","DESCRIPCION","ID_VIVIENDA ORDER BY CALLE REVERSE"};
        model = new DefaultTableModel(null,columnas);
